      ...
      <Container>
        <Container>
          ...
          <Content2
            id="About"
            title="Sobre nós"
            description="Nós somos dois estudantes da Universidade Federal de Sergipe, onde cursamos o 4º período. Extremamente apaixonados por tecologia e entusiastas nas áreas, tanto web e mobile, quanto jogos. Temos ambos a mesma idade (20 anos). No momento trabalhamos na SofTeam, Empresa Júnior de Computação, onde aprendemos bastante diariamente. Para ver outros dos nossos projetos você pode acessar os links acima."
          />
          <Content4
            id="Contact"
            title="Contato"
            description={`Para entrar em contato acesse nossas redes sociais, nos mande um email`}
          />
          <Footer />
        </Container>
      </Container>
